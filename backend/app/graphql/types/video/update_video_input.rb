module Types
  module Video
    class UpdateVideoInput < Types::BaseInputObject
      ...
      argument :category, String, required: false, description: "Categoria do vídeo."
      ...
      argument :publicationDate, GraphQL::Types::ISO8601Date, required: false, description: "Data de publicação do vídeo."
    end
  end
end
